  ...
  <div>
    <div class="page-title">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>员工新增</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
          ...
          <el-form  :rules="rules"  ref="filterQuery"  label-width="150px" :model="filterQuery">     
                 ...
                 <el-col :span="12">
                   <el-form-item label="出生日期：">
                    ...
                    placeholder="选择日期">
                     ...
                     <!-- <el-input v-model="filterQuery.birthday" placeholder="出生日期"></el-input> -->
                   </el-form-item>
                 </el-col>
               </el-row>
               <el-row>
                 ...
                 <el-col :span="12">
                   <el-form-item label="参加工作时间：">
                     ...
                     <!-- <el-input v-model="filterQuery.jobtime" placeholder="参加工作时间"></el-input> -->
                   </el-form-item>
                 </el-col>
               </el-row>
               <el-row>
               ...
               <el-row> 
                <el-col :span="12">
                 ...
                 <el-col :span="12">
                   <el-form-item label="手机号码："  prop="tel" :required="false">
                     <el-input v-model="filterQuery.tel" placeholder="手机号码" ></el-input>
                   </el-form-item>
                 </el-col>      
               </el-row>
               <el-form-item>
...
<script>
import {CreateStaff} from '../../../services/staffmanagement'
  ...
  data() {
    return{
      filterQuery:{
        ...
        // empGroup :[{required: true, message: '请选择科室', trigger: 'change' }],
        ...
        email: [{required: false,trigger: ['blur', 'change'] },{
        ...
        tel: [{ required: false, trigger: ['blur', 'change'] },{
          validator:function(rule,value,callback){
    ...
    handleSubmit (formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          CreateStaff(this.filterQuery).then(() => {
