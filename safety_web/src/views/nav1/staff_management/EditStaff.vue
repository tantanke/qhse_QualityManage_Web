					...
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="出生日期:">
								<el-date-picker v-model="filterQuery.birthday" type="date" style="width:100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
								 placeholder="选择日期">
								</el-date-picker>
							</el-form-item>
						</el-col>
					...
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="参加工作时间:">
								<el-date-picker v-model="filterQuery.jobTime" type="date" style="width:100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
								 placeholder="选择日期">
								</el-date-picker>
							</el-form-item>
						</el-col>
					...
					<el-row>
						<el-col :span="12">
							<el-form-item label="所在科室：" prop="empGroup">
								<el-autocomplete v-model="inputEmpGroup" clearable :fetch-suggestions="querySearch2" placeholder="所在科室" style="width:100%"
						...
						<el-col :span="12">
							<el-form-item label="文化程度:">
								<el-select v-model="filterQuery.education" placeholder="文化程度" clearable style="width:100%">
									<el-option v-for="item in education1" :key="item.id" :label="item.name" :value="item.name">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
						...
						<el-col :span="12">
							<el-form-item label="员工类别：" prop="category">
								<el-select v-model="filterQuery.category" placeholder="请选择员工类别" style="width:100%">
									<el-option v-for="item in categorys" :key="item.label" :label="item.label" :value="item.label">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
			...
			handleSubmit(formName) {
				this.$refs[formName].validate((valid) => {
					if (valid) {
						...
						console.log('update data', this.filterQuery)
