<template>
    <div>
        ...
        <div class="page-content">
            <el-row>
                <el-form label-width="130px" :inline="true">
                    ...
                    <el-form-item>
                        ...
                        <el-button type="primary" icon="el-icon-upload " @click="isCheckIn=true;resData={}">手动录入</el-button>
                    </el-form-item>
            ...
            <el-dialog title="新增计划" :visible.sync="ifchange" center width="700px">
                <el-form label-width="120px" style="width:100%;">
                    <el-row>
                        ...
                        <el-col :span="24">
                            <el-form-item>
                                <el-button type="" style="margin-top:20px;margin-left:100px" @click="ifchange=false">
                                    取消
                                </el-button>
            ...
            <!-- 手动录入 -->
            <el-dialog title="手动录入" :visible.sync="isCheckIn" center width="700px">
                <el-form label-width="120px" style="width:100%;">
                    <el-row>
                        <el-col :span="24">
                            <el-form-item label="设备编号:" prop="deviceNo" style="margin-bottom:1px">
                        ...
                        <el-col :span="24">
                            <el-form-item>
                                <el-button type="" style="margin-top:20px;margin-left:100px" @click="isCheckIn=false">
                                    取消
                                </el-button>
                                <el-button type="primary" style="margin-top:20px;" @click="confirmCheckIn">确定录入</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
