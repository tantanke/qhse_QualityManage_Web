                ...
                <div v-for="(item,index) in attachs" :key="index"
                  ...
                  <el-card :body-style="{ padding: '10px' }"
                    ...
                    <el-popover placement="none" title trigger="click" class="hidbg">
                      <div
                        style="position: fixed;left: 50%;top: 50%;transform: translate(-50%, -50%); box-shadow: 0 0 2px 4px rgba(0,0,0,0.3);">
                        <img :src="item" style="max-width:1400px;height:auto; vertical-align: bottom;" />
                      </div>
