	...
	<div>
		...
		<div class="page-content">
			<div class="form-content">
						...
						<el-col :span="12">
							<el-form-item label="性别：">
								<el-select v-model="information.sex" placeholder="性别" style="width: 100%;">
									<el-option v-for="item in sexes" :key="item.id" :label="item.name" :value="item.name">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
					...
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="出生日期：">
								<el-date-picker v-model="information.birthday" type="date" style="width:100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
								 placeholder="选择日期">
								</el-date-picker>
							</el-form-item>
						</el-col>
					...
					<el-row>
						...
						<el-col :span="12">
							<el-form-item label="参加工作时间：">
								<el-date-picker v-model="information.jobTime" type="date" style="width:100%" format="yyyy-MM-dd" value-format="yyyy-MM-dd"
								 placeholder="选择日期">
								</el-date-picker>
							</el-form-item>
						</el-col>
						...
						<el-col :span="12">
							<el-form-item label="文化程度：">
								<el-select v-model="information.education" placeholder="文化程度" clearable style="width:100%">
									<el-option v-for="item in educations" :key="item.id" :label="item.name" :value="item.name">
									</el-option>
								</el-select>
							</el-form-item>
						</el-col>
				...
				<!-- 修改密码表单 -->
				<el-form label-width="150px" :model="updatePassword" :rules="passwordRules">
					<el-row style="padding-bottom:5px">
					...
					<el-row style="padding-top:5px; border-top: 2px solid #dddddd">
						<el-col :span="24">
							<el-form-item label="旧密码：" prop="oldPassword">
								<el-input type="password" style="width:100%" v-model="updatePassword.oldPassword" placeholder="请输入旧密码"></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="24">
							<el-form-item label="新密码：" prop="newPassword1">
								<el-input type="password" style="width:100%" v-model="updatePassword.newPassword1" placeholder="请输入新密码"></el-input>
							</el-form-item>
							<el-form-item label="确认密码：" prop="newPassword2">
								<el-input type="password" style="width:100%" v-model="updatePassword.newPassword2" placeholder="再次确认新密码"></el-input>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row class="buttons">
	...
	export default {
			...
			return {
				...
				passwordRules: {
					...
					newPassword1: [{
						...
						validator: function(rule, value, callback) {
							console.log(value)
							if (/^(?![0-9]+$)(?![a-zA-Z]+$)[0-9a-zA-Z\W]{12,18}$/.test(value) == false) {
								callback(new Error("新密码必须是12位以上的数字、字母、字符任意两种组合！"));
							} else {
								callback();
							}
						}
		...
		methods: {
			...
			handleSubmitPassword() {
				if (this.updatePassword.newPassword1 == this.updatePassword.newPassword2) {
					this.password.newPassword = this.updatePassword.newPassword1
					this.password.oldPassword = this.updatePassword.oldPassword
					UpdateStaff(this.password).then(() => {
						this.$message.success('密码更新成功')
						this.password.newPassword = ''
						this.password.oldPassword = ''
						this.updatePassword.newPassword1 = '';
						this.updatePassword.newPassword2 = '';
					}).catch(err => {
