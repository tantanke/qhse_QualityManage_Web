<template>
    ...
    <div class="page-title" style="width:100%">我单位的问题</div>
  ...
  <div v-else>
    ...
    <div class="page-title">我单位的问题</div>
    <div class="page-content">
       <el-form
        :inline="true"
        :model="filterQuery"
...
import {GetProblemList2} from '../../../services/problem'
import Vue from 'vue'
...
export default {
  ...
  methods:{
    ...
    open(data) {
      ...
      this.excelData=GetProblemList2(this.filterQueryExcel).then((data) => {
    ...
    gettaskName(){
        GetProblemList2(this.fitertask).then((res) => {  
      ...
      GetProblemList2(this.filterQuery).then((res) => {
