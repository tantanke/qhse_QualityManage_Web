		...
		<div
            ...
            <el-dialog
                ...
                <span slot="footer" class="dialog-footer">
                    <el-button type="danger" @click="problemVerifyRefuse(rectifyForm.qulity_CheckRecordID)" v-if="isBelongToPart === true" icon="el-icon-close">打 回</el-button>
					<el-button type="primary"  @click="problemVerifySubmit(rectifyForm.qulity_CheckRecordID)" v-if="isBelongToPart === true" icon="el-icon-check">通 过</el-button>
