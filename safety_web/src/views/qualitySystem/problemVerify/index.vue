		...
		element-loading-spinner="el-icon-loading">
			...
			<el-table :data="problemList" border stripe>
				...
				<el-table-column label="操作" align="center" width="120" fixed="right">
				    <template slot-scope="scope">
				        <el-button type="warning" icon="el-icon-edit" size="mini" @click="jumpProblemVerify(scope.row)" v-if="scope.row.isPush === '已推送' && scope.row.issued === '已下达'">问题验证</el-button>
				        <el-button type="success" icon="el-icon-success" size="mini" @click="jumpProblemVerify(scope.row)" v-else>查看信息</el-button>
				    </template>
				</el-table-column>
			</el-table>
		</div>
