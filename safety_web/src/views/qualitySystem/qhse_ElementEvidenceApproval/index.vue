<template>
  <div>
    <div class="page-title" style="width:100%">质量-要素证据批准</div>
    <div class="page-content">
      ...
      <el-row style="padding:10px; border-top: 2px dashed #dddddd;">
        ...
        <el-table v-if="checkType=='未批准'" :data="treeData" style="width: 100%;text-align:center" ref="treeTable"
          ...
          <el-table-column label="操作" width="150" align="center">
            <template slot-scope="scope">
              <el-button type="primary" size="mini" @click="updateScore(scope.row)"
                v-if="scope.row.childNode.length === 0 && scope.row.status==='未批准' ">进入批准</el-button>
            </template>
          </el-table-column>
        </el-table>
        <el-table v-if="checkType=='已批准'" :data="hasData" style="width: 100%;text-align:center" ref="treeTable"
          row-key="code" :indent="30" max-height="560" highlight-current-row border @cell-click="handleCellClick"
          v-loading="loading" :tree-props="{children: 'childNode', hasChildren: 'hasChildren'}">
          <el-table-column prop="name" label="内容"></el-table-column>
          <!-- <el-table-column prop="status" label="状态" width="80" align="center"></el-table-column> -->
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item style="margin-left:300px;text-align:left">
                <el-switch style="margin-right:10px" v-model="upstatus" active-color="#13ce66" inactive-color="#ff4949"
              ...
              <el-form-item v-if="!upstatus" label="驳回意见：" style="margin-bottom:1px">
                <el-input ype="text" label="驳回意见 ：" class="resizeNone" v-model="unpasstext" placeholder="请输入内容">
                </el-input>
              </el-form-item>
...
import { query_elementReviewers } from "../../../services/qualitySystem/quality_EvidenceCheck"//证据项
import { approval_elementReviewer } from "../../../services/qualitySystem/quality_EvidenceCheck"//通过批准
