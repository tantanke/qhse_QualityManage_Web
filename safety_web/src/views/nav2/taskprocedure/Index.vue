...
<template>
  <div class="outDiv">
    ...
    <div class="page-title" style="width:100%">任务工序配置</div>
    ...
    <!--新增事件节点分类弹窗-->
      ...
      <el-form ref="addEventForm" :model="addEventForm">
        <el-form-item label="任务工序名称" prop="categoryName" >
...
import {GetTaskProcedure} from '../../../services/gettreedata'
import {Createtaskprocedure,delete_tree} from '../../../services/taskprocedure'
export default {
    watch: {
    filterText(val) {
    ...
    methods: {
      ...
      this.$confirm('此操作将永久删除该条记录, 是否继续?', '提示', {
        ...
        this.taskAndProcessPojo.taskAndProcessCode = nodeCode
      ...
      addEventFormSubmitBtn(formData){
        let newChild = { "taskAndProcessName": formData.categoryName,"taskAndProcessCode": this.addNodeCode};
