  ...
  <div>
               ...
               <el-row>
                 ...
                 <el-col :span="12">
                   <el-form-item label="检查负责人："  prop="reportCheckPersonID">
                     <el-select
                v-model="filterQuery.reportCheckPersonID"
                placeholder="输入姓名搜索员工"
                :filter-method="handlegetEmployees" 
                clearable
                filterable
                style="width:100%"
               ...
               <el-row>
                 <el-col :span="12">
                   <el-form-item label="报告计划时间：" prop="reportPlanDate">
                    <el-date-picker
                    v-model="filterQuery.reportPlanDate"
                    type="date"
                    style="width:100%"
                    format="yyyy-MM-dd"
    ...
    <!-- 报告计划列表table -->         
      ...
      <el-table
        ...
        <el-table-column label="报告编号" prop="reportCode" min-width="100%" header-align="center" align="center"> </el-table-column>
        <el-table-column label="基层单位" prop="companyName" width="250px" header-align="center" align="center"> </el-table-column>
        <el-table-column label="计划时间" prop="reportPlanDate" width="100px" header-align="center"> </el-table-column>
        <el-table-column label="报告类别" prop="reportType" width="250px" header-align="center" align="center"> </el-table-column>
...
<!--修改计划弹窗-->
      ...
      <el-form  :rules="rules"  ref="changeReport" label-width="150px" :model="changeReport" >     
               <el-row>
                 <el-col :span="12">
                   <el-form-item label="检查负责人"  prop="reportCheckPersonID">
                     <el-select
                v-model="changeReport.reportCheckPersonID"
                placeholder="输入姓名搜索员工"
                :filter-method="handlegetEmployees" 
                clearable
                filterable
              ...
              >
                <el-option
                 ...
                 <el-col :span="12">
                   <el-form-item label="基层单位:" prop="companyCode">
                     ...
                     :options="options"
                     placeholder="请选择单位名称"
                     v-model="changeReport.companyCode"
                     style="width:100%"
                     /> 
                   </el-form-item>
                 </el-col>
               ...
               <el-row>
                 <el-col :span="12">
                   <el-form-item label="报告计划时间:" prop="reportPlanDate">
                    <el-date-picker
                    v-model="changeReport.reportPlanDate"
                    type="date"
                    style="width:100%"
                    format="yyyy-MM-dd"
                    value-format="yyyy-MM-dd"
  ...
  <div class="pagination-base">
        <el-pagination
          ...
          :current-page="listcondition.pageIdx"
          :page-size="listcondition.pageSize"
          :total="total"
          background
...
import {CreateReport,UpdateReport,GetReport,DeleteReport,GetReportDetail} from '../../../services/reportplan'
  ...
  data() {
    return{
      ...
      tableData:[],
       ...
       options:[],//存放单位
       rules:{
        reportCheckPersonID :[{required: true, message: '请选择检查负责人', trigger: ['blur', 'change']}],
        companyCode :[{required: true, message: '请选择单位名称',trigger: ['blur', 'change']}],
        count :[{required: true, message: '请填写报告份数', trigger: ['blur', 'change'] }],
        reportType :[{required: true, message: '请选择报告类别', trigger: ['blur', 'change'] }],
        reportPlanDate :[{required: true, message: '请选择报告计划时间', trigger: ['blur', 'change']}]
      }
    } 
  },
  mounted(){
