  ...
  var wb = new Workbook(),
    ws = sheet_from_array_of_arrays(data);
      ...
      for(var i=0;i<header.length;i++){
        ...
        //设备表头样式
        var head = str + "1";
        ws[head].s =  { font: { sz: 16, bold: true, color: { rgb: "000000" }, family:"微软雅黑"},
                        alignment:{vertical:"center",horizontal:"center"},
                        fill: { bgColor: { indexed: 64 }, fgColor: { rgb: "7CCD7C" } } }
        //设置内容样式
        for (let j = 2; j < data.length+1; j++) {
          var body =  str + j;
          ws[body].s =  { font: { sz: 12},alignment:{vertical:"center",horizontal:"center",wrapText:"true"} }
        }
      }
      if(merges){
        //合并单元格
