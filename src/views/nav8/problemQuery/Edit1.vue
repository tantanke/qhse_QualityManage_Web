<template>
  <div v-if="this.client === 'android'">
      ...
      <el-breadcrumb-item><a @click="$router.go(-1)">我录入的问题</a></el-breadcrumb-item>
        <el-breadcrumb-item>计划内问题</el-breadcrumb-item>        
      </el-breadcrumb>        
    </div>
    <div class="page-content">
         ...
         <el-col :span="12">
            <div class="grid-content bg-purple">
             <el-form-item label="任务名称：" prop="taskName">
              <el-input v-model="formData.taskName" readonly></el-input>
              <!-- <el-p v-model="formData.taskName" style="width:250px;margin-left:0px">{{formData.taskName}}</el-p> -->
             <!-- <el-input v-model="formData.taskName" placeholder="任务名称" disabled></el-input> -->
            </el-form-item>
          </div>
         </el-col>        
          <el-col :span="12">
           <div class="grid-content bg-purple">
            <el-form-item label="检查级别：" prop="checkRank">
              <el-input v-model="checkRank" readonly></el-input>
              <!-- <el-p v-model="formData.checkRank" style="width:250px;margin-left:0px">{{checkRank}}</el-p> -->
              <!-- <el-input v-model="formData.checkRank" placeholder="检查级别" disabled></el-input> -->
            </el-form-item>
           </div>
          </el-col>
        </el-row>
        <el-row>         
         <el-col :span="12">
             ...
             <el-form-item label="检查日期：" prop="checkDate">
                 <el-date-picker
                  v-model="formData.checkDate" style="width:250px;margin-left:0px"   type="datetime"
      ...
      <el-col :span="12">
            <el-form-item label="员工组：" prop="responseEmpGroup">
              <el-input v-model="formData.responseEmpGroup"  readonly></el-input>
            </el-form-item>
         </el-col>
        </el-row>
        <el-row>
             ...
             <div class="grid-content bg-purple-dark">
              <el-form-item label="整改期限：" prop="limtRectDate">
                 <el-date-picker
                  ...
                  value-format="yyyy-MM-dd" placeholder="选择日期" :editable="false">
                 </el-date-picker>
              </el-form-item>    
             </div>
         </el-col>
        ...
        <el-row>
         ...
         <el-col :span="12">
             <div class="grid-content bg-purple">
                <el-form-item label="问题类别2：" prop="problemClass2">
                  <el-select v-model="formData.problemClass2" placeholder="问题类别2" 
                  style="width: 100%;" 
                  @change="onChangedProblemClass2">
                    <el-option
           ...
           <el-row>
             <el-col :span="12">
              ...
              <video v-if="formData.checkVideo !='' && videoFlag1 == false"
                ...
                <i v-if="formData.checkVideo =='' && videoFlag1 == false" class="el-icon-plus avatar-uploader-icon"></i>
      ...
      <div class="form-content">
        ...
        <el-row>
         <el-col :span="12">
            <div class="grid-content bg-purple">
             <el-form-item label="任务名称：" prop="taskName">
              <el-input v-model="formData.taskName" readonly></el-input>
              <!-- <el-p v-model="formData.taskName" style="width:280px;margin-left:0px">{{formData.taskName}}</el-p> -->
             <!-- <el-input v-model="formData.taskName" placeholder="任务名称" disabled></el-input> -->
            </el-form-item>
          </div>
         </el-col>        
          <el-col :span="12">
           <div class="grid-content bg-purple">
            <el-form-item label="检查级别：" prop="checkRank">
              <el-input v-model="checkRank" readonly></el-input>
              <!-- <el-p v-model="formData.checkRank" style="width:280px;margin-left:0px">{{checkRank}}</el-p> -->
              <!-- <el-input v-model="formData.checkRank" placeholder="检查级别" disabled></el-input> -->
            </el-form-item>
           </div>
          </el-col>
        ...
        <el-row>         
         <el-col :span="12">
             ...
             <el-form-item label="检查日期：" prop="checkDate">
                 <el-date-picker
                  v-model="formData.checkDate" style="width:280px;margin-left:0px"   type="datetime"
...
import {Getproblemdescriptions,GetTaskProcess,GetProcesses,GetDescriptions,GetProblemSources,GetProblemClass1s,GetProblemClass2s} from '../../../services/ProblemInput.js'
// import {GetTaskProcess,GetProcesses,GetDescriptions,GetCompanys,GetProblemSources,GetProblemClass1s,GetProblemClass2s} from '../../../services/ProblemInput.js'
import {UpdateProblem} from '../../../services/problem'
import {GetPersonalProblemDetail} from '../../../services/personCenter'
    ...
    return {
      ...
      options2: [
       ...
       rules:{
        ...
        problemClass2 :[{required: true, message: '问题类别2不可为空', trigger: 'blur' }],
  ...
  methods: {
   handleSubmit (formName) {
       this.$refs[formName].validate((valid) => {
          if (valid) {
            this.formData.status='未审核'
            console.log(JSON.stringify(this.formData)) 
            UpdateProblem(this.formData.problemID,this.formData).then(() => {
     ...
     getproblem() {
      ...
      GetPersonalProblemDetail(id).then((res) => {
        ...
        //  console.log(JSON.stringify(res))  
          this.checkRank = res.data.checkRank
        }).catch((err) => {
        this.$message.error(err.message)
        })
