 ...
 <!-- 点击某一问题，查看详情的form表单 -->
    ...
    <el-table-column label="操作" align="center" header-align="center" width="250px" >
      <template slot-scope="scope">
        <div class="inline-td">
          <router-link :to='{name: "PersonalRectify", params: {id: scope.row.problemID}}' >
...
<script>
import {ProblemStatus} from '../../../services/verify'
...
export default {
  ...
  methods:{
    ...
    export2Excel() {
      ...
      this.excelData=ProblemStatus(this.filterQueryExcel).then((data) => {
  ...
  //获取全部问题，显示在table
    handleGetProblems () {
      ...
      ProblemStatus(this.filterQuery).then((res) => {
